var dsLocalClass = 'Anhui Barberry'
function dropdown_show() {
  document.getElementById("dropdown_cf").classList.toggle("show");
}

// Close the dropdown menu if the user clicks outside of it
window.onclick = function (event) {
  if (!event.target.matches('.dropbtn')) {
    var dropdowns = document.getElementsByClassName("dropdown-content-cf");
    var i;
...
var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
...
Plotly.newPlot('InteractiveElement6', data, layout, { displayModeBar: false });

function cfclass1(cfbutton) {
  ...
  dsLocalClass = cfbutton.innerHTML;

  var test_instance_1 = document.getElementById('testinstance1button');
  var test_instance_2 = document.getElementById('testinstance2button');
  var test_instance_3 = document.getElementById('testinstance3button');
  var test_instance_4 = document.getElementById('testinstance4button');
  var test_instance_5 = document.getElementById('testinstance5button');

  if (test_instance_1.disabled) {

    var test_instance_image = document.getElementById('image_cf');
    test_instance_image.src = "img/anhui.jpg";
  ...
  } else if (test_instance_2.disabled) { // cf class: chinese horse

    var test_instance_image = document.getElementById('image_cf');
    test_instance_image.src = "img/chinese_horse_chestnut.jpg";
    test_instance_image.width = "300";
    test_instance_image.height = "225";
  ...
  } else if (test_instance_3.disabled) { // cf class: chinese horse
  ...
  } else if (test_instance_4.disabled) { // cf class: chinese horse
  ...
  } else if (test_instance_5.disabled) {
...
function cfclass2(cfbutton) {
  cfbutton.disabled = true;
  var cfbutton1 = document.getElementById('cfclass1button');
  var cfbutton3 = document.getElementById('cfclass3button');
  var cfbutton4 = document.getElementById('cfclass4button');
  cfbutton1.disabled = false;
  cfbutton3.disabled = false;
  cfbutton4.disabled = false;
  ...
  if (test_instance_1.disabled) {
    ...
    var test_instance_image = document.getElementById('image_cf');
    test_instance_image.src = "img/chinese_redbud.jpg";
    test_instance_image.width = "300";
    test_instance_image.height = "225";

    var final_plot_image_cf = document.getElementById('final_plot_image_cf');
    final_plot_image_cf.src = "img/chinese_redbud.jpg";
    final_plot_image_cf.width = "300";
    final_plot_image_cf.height = "225";
    ...
    var table = {
      ...
      cells: {
        ...
        ["<b>The leaf would be Chinese redbud if perimeter were very small and area were not very small.</b>", "The leaf would be Chinese redbud if perimeter were very large."],
        ],
        align: "center",
        line: { color: "black", width: 1 },
        font: { family: "Arial", size: 11, color: ["black"] },
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var trace3 = { // class 3.0
      x: [2394.802307, 2384.795165, 2437.179941, 2386.73629, 2366.9373, 2467.304833, 2500.978931, 2536.961687, 2569.020561, 2726.826694, 2680.96883, 2713.848989, 2729.589104, 2657.630735, 2760.383043, 2793.547473, 2806.660172, 2836.358657, 2884.584053, 2859.73124, 2868.015511, 2907.838887, 2964.303966, 2890.262336, 2947.946535, 2846.858223],
      y: [326683.0, 329343.0, 336922.0, 337142.0, 341930.0, 342251.0, 356991.0, 381311.0, 386085.0, 399086.0, 414051.0, 417094.0, 418705.0, 420067.0, 422148.0, 432550.0, 436905.0, 447403.0, 451667.0, 462175.0, 478749.0, 491096.0, 349045.0, 350832.0, 353741.0, 359217.0],
      mode: 'markers',
      type: 'scatter',
      name: 'CF class<br>(FL)',
      hovertemplate: 'Area:%{y}<br>Perimeter:%{x}',
    ...
    var data_final_plot = [trace1, trace3, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  } else if (test_instance_2.disabled) {
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace2, trace3, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  } else if (test_instance_3.disabled) {
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace3, trace2, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  } else if (test_instance_4.disabled) {
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace4, trace2, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace5, trace2, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
...
function cfclass3(cfbutton) {
  ...
  if (test_instance_1.disabled) {
    ...
    var test_instance_image = document.getElementById('image_cf');
    test_instance_image.src = "img/nanmu.jpg";
    test_instance_image.width = "300";
    test_instance_image.height = "225";

    var final_plot_image_cf = document.getElementById('final_plot_image_cf');
    final_plot_image_cf.src = "img/nanmu.jpg";
    final_plot_image_cf.width = "300";
    final_plot_image_cf.height = "225";
    ...
    var table = {
      ...
      cells: {
        values: [["<b>R8</b>", "R9", "R10"],
        ["<b>2.701</b>", "2.701", "2.865"],
        ["<b>IF Perimeter=MF5 AND Area=MF6 THEN Leaf IS Nanmu</b>", "IF Perimeter=MF6 AND Area=MF7 THEN Leaf IS Nanmu", "IF Perimeter=MF7 AND Area=MF8 THEN Leaf IS Nanmu"],
        ["<b>The leaf would be Nanmu if perimeter were small and area were very small.</b>", "The leaf would be Nanmu if perimeter were medium and area were very small.", "The leaf would be Nanmu if perimeter would be very small and area would be very small."],
        ],
        align: "center",
        line: { color: "black", width: 1 },
        font: { family: "Arial", size: 11, color: ["black"] },
  ...
  var data = [trace_perimeter, perimeter_text, trace_area, area_text, trace_area_scaling, trace_perimeter_scaling, table];
  ...
  var axis = {
    ...
    var trace4 = { // class 4.0
      x: [3162.879651, 3201.880518, 3414.833837, 3322.331311, 3288.556708, 3172.456203, 3377.260244, 3368.88261, 3576.516303, 3606.367025, 3307.309017, 3338.051224, 3216.906997, 3345.375034, 3540.776188, 3352.061325, 3659.90613, 3441.191268, 3556.301008, 3572.720272, 4036.418757, 3784.433042, 3697.188309, 3357.683692, 3681.129435, 3589.656347, 3605.708078, 3690.075611, 3854.835062, 3501.423807, 3870.097039, 3617.413706, 3717.379218, 3700.945669, 3881.753893, 3792.349781],
      y: [334613.0, 344136.0, 358769.0, 384758.0, 394982.0, 397790.0, 415386.0, 427805.0, 431413.0, 433519.0, 435325.0, 437264.0, 454179.0, 469774.0, 472499.0, 476454.0, 479559.0, 482767.0, 494218.0, 494234.0, 511537.0, 511577.0, 516259.0, 519952.0, 546009.0, 548851.0, 555336.0, 566870.0, 581962.0, 582167.0, 585467.0, 586265.0, 586582.0, 587593.0, 599995.0, 601679.0],
      mode: 'markers',
      type: 'scatter',
      name: 'CF class<br>(FL)',
      hovertemplate: 'Area:%{y}<br>Perimeter:%{x}',
    ...
    var data_final_plot = [trace1, trace4, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
    ...
    var table = {
      ...
      cells: {
        values: [["<b>R9</b>", "R10", "R8"],
        ["<b>2.682</b>", "2.682", "2.884"],
        ["<b>IF Perimeter=MF6 AND Area=MF7 THEN Leaf IS Nanmu</b>", "IF Perimeter=MF7 AND Area=MF8 THEN Leaf IS Nanmu", "IF Perimeter=MF5 AND Area=MF6 THEN Leaf IS Nanmu"],
        ["<b>The leaf would be Nanmu if perimeter were medium and area were very small.</b>", "The leaf would be Nanmu if perimeter would be very small and area would be very small.", "The leaf would be Nanmu if perimeter were small and area were very small."],
        ],
        align: "center",
        line: { color: "black", width: 1 },
        font: { family: "Arial", size: 11, color: ["black"] },
    ...
    var trace_perimeter = {
      x: [4528.174, 4647.778, 6054.299, 6156.223, 4528.174],
      y: [0, 1, 1, 0, 0],
      type: 'scatter',
      //name: 'Perimeter',
      //title: 'Perimeter',
    ...
    var trace_area = {
      x: [112823.0, 112823.0, 694774.0, 819972.0, 112823.0],
      y: [0, 1, 1, 0, 0],
      type: 'scatter',
      //name: 'Area',
      //title: 'Area',
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var trace4 = { // class 4.0
      x: [5203.976331, 4647.77828, 5266.846389, 5006.035206, 4933.702161, 5084.076836, 5138.478857, 5316.16724, 5126.721497, 5369.373301, 5251.959087, 6054.299274, 6003.429217],
      y: [284048.0, 561767.0, 567663.0, 587000.0, 589675.0, 593628.0, 611364.0, 631801.0, 652510.0, 667296.0, 667984.0, 690910.0, 694774.0],
      mode: 'markers',
      type: 'scatter',
      name: 'CF class<br>(FL)',
      hovertemplate: 'Area:%{y}<br>Perimeter:%{x}',
    ...
    var data_final_plot = [trace2, trace4, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var axis2_table = { domain: [0, 0.5], anchor: 'x1' }
    var axis1_2 = { domain: [0.0, 0.45], anchor: 'y2' }
    var axis2_2 = { domain: [0, 0.52], anchor: 'x2' }
    var axis1_3 = { domain: [0.55, 1], anchor: 'y3' }
    var axis2_3 = { domain: [0, 0.52], anchor: 'x3' }
    ...
    var data_final_plot = [trace3, trace4, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace4, trace3, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace5, trace3, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
...
function cfclass4(cfbutton) {
  ...
  if (test_instance_1.disabled) {
    ...
    var final_plot_image_cf = document.getElementById('final_plot_image_cf');
    final_plot_image_cf.src = "img/crape_myrtle.jpg";
    final_plot_image_cf.width = "300";
    final_plot_image_cf.height = "225";
    ...
    var table = {
      ...
      cells: {
        ...
        ["<b>The leaf would be Crape myrtle if perimeter were medium and area were very small.</b>"],
        ],
        align: "center",
        line: { color: "black", width: 1 },
        font: { family: "Arial", size: 11, color: ["black"] },
  ...
  var data = [trace_perimeter, perimeter_text, trace_area, area_text, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var trace5 = { // class 5.0
      x: [2893.462479, 3272.038164, 3166.748842, 2867.462479, 3268.1803, 3428.98434, 3427.812768, 3488.506202, 3378.682825, 3245.34473, 3430.873734, 3757.557067, 3450.623951, 3545.643287, 3653.466663, 3748.797616, 3620.25346, 3529.182392, 3653.934701, 3237.361974, 3459.636144, 3603.182392, 3624.780372, 3632.145812, 3612.09408, 3497.594514, 3544.721497, 3592.177341, 3519.626043, 3453.761036, 3472.440185, 3362.06551, 3584.915365, 3430.54069, 3399.552883, 3396.38131, 3420.94271, 3404.682825, 3382.523446, 3532.405697, 3705.224023, 3505.025971, 3568.638236, 3363.77828, 3631.224023, 3495.425033, 3582.430083, 3613.584412, 3518.364066, 3726.478857, 3555.41789, 3618.412839, 3723.449419, 3645.442277, 3740.922507],
      y: [112823.0, 143189.0, 156439.0, 158002.0, 180081.0, 188627.0, 188774.0, 198225.0, 198990.0, 205252.0, 205655.0, 209532.0, 213648.0, 214745.0, 218501.0, 220764.0, 221338.0, 223325.0, 223453.0, 225910.0, 226131.0, 227030.0, 228131.0, 228955.0, 229320.0, 229953.0, 231316.0, 231791.0, 234261.0, 235805.0, 236897.0, 236977.0, 237086.0, 239775.0, 240371.0, 240688.0, 241368.0, 241635.0, 242771.0, 248304.0, 248883.0, 249328.0, 250473.0, 251600.0, 254261.0, 256489.0, 258378.0, 260886.0, 265287.0, 268625.0, 271608.0, 272387.0, 272523.0, 275644.0, 277540.0],
      mode: 'markers',
      type: 'scatter',
      name: 'CF class<br>(FL)',
      hovertemplate: 'Area:%{y}<br>Perimeter:%{x}',
    ...
    var data_final_plot = [trace1, trace5, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace2, trace5, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace3, trace5, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace4, trace5, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
  ...
  var data = [trace_perimeter, text_perimeter, trace_area, text_area, trace_area_scaling, trace_perimeter_scaling, table];
    ...
    var data_final_plot = [trace5, trace4, trace_perimeter_very_small, trace_perimeter_small, trace_perimeter_medium, trace_perimeter_large, trace_perimeter_very_large, trace_area_very_small, trace_area_not_very_small, trace_rule_markers];
